...
//    ArrayList<ASSIGNMENT_EOD_STATUS> dataset;
    
    
    public ArrayList<ASSIGNMENT_EOD_STATUS> getTableObject(String p_businessDate,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
...
Map<String,DBRecord>l_tableMap=new HashMap();
        ...
        l_tableMap=readBuffer.readTable("BATCH"+i_db_properties.getProperty("FOLDER_DELIMITER")+p_businessDate+i_db_properties.getProperty("FOLDER_DELIMITER")+p_businessDate, "BATCH", "ASSIGNMENT_EOD_STATUS", session, dbSession,ismaxVersionRequired);
