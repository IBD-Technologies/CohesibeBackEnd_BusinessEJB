...
//    ArrayList<BATCH_STATUS_HISTORY> dataset;
    ...
    public ArrayList<BATCH_STATUS_HISTORY> getTableObject(String p_businessDate,String p_instituteID,CohesiveSession session,DBSession dbSession,ReportDependencyInjection inject)throws DBProcessingException,DBValidationException{
...
Map<String,DBRecord>l_tableMap=null;
    ...
    private ArrayList<BATCH_STATUS_HISTORY> convertDBtoReportObject(Map<String,DBRecord>l_tableMap,CohesiveSession session)throws DBProcessingException{
